...
class Event extends Component {
  ...
  render() {
    ...
    const data = [{ name: "Attending", value: event.yes_rsvp_count }, { name: "Available", value: (event.rsvp_limit - event.yes_rsvp_count) }];
    ...
    return (
      <div className="event">
        <div className="event__Overview">
          ...
          <h2 className="event__Overview--name">{this.props.event.name}</h2>
          ...
          {!event.rsvp_limit &&
            <p>{event.yes_rsvp_count} People Joining</p>
          }
          {showDetails &&
        ...
        {showDetails &&
          <div className="event__Details">
            <h3>Infos</h3>
            <h4><a href={this.props.event.link} target="blank">Attend MeetUp</a></h4>
